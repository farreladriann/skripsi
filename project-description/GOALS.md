...
1. Simpang Kronggahan (Akses masuk ke arah RSA UGM)
2. Simpang Jombor (Titik potong dengan Jalan Magelang, terdapat flyover)
3. Simpang Monjali (Titik potong Jalan Monumen Jogja Kembali dan Jalan Palagan Tentara Pelajar)
4. Simpang Kentungan (Titik potong dengan Jalan Kaliurang, terdapat underpass)
5. Simpang Condongcatur (Titik potong dengan Jalan Affandi/Gejayan)
6. Simpang UPN/Seturan/Babarsari (Terus mengarah ke timur menuju Simpang Maguwoharjo)

Jalan tol jogja solo akan membangun empat exit tol ramp on/off di Jalan Ring Road Utara.

Desain ramp-nya adalah:

- Ramp On (masuk tol, mengarah ke tol layang) → berada di sisi utara Ring Road Utara.
- Ramp Off (keluar tol, mengarah turun ke jalan arteri) → berada di sisi selatan Ring Road Utara.


Keempat exit tol joga solo:

1. Exit Maguwoharjo: Kawasan Sanggrahan, barat SMKN 1 Depok, Ring Road Utara (paling timur). Timur nya Simpang UPN/Seturan/Babarsari.
2. Exit UPN: Sebelah barat Jl. Nusa Indah, Ring Road Utara. Di antara Simpang Condongcatur dan Simpang UPN/Seturan/Babarsari.
